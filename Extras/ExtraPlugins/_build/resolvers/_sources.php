...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'ExtraPlugins',
                'description' => 'Default source for files of ExtraPlugins',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/extraplugins/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'extraplugins_source_default'))) {
